...
public class WhatIsVarArgs {
    ...
    public void testAdd(){
        ...
        addAllNumbers(  new int[]{1,2,3,4,5,6}  ); //21

       addAllNumbersVarArgs( 1,2,3,4,5); //15
       addAllNumbersVarArgs( 1,2,3,4,5,3,4,5,6,7,8,9,90,4,5,6); //162
       addAllNumbersVarArgs(1,2); //3
       addAllNumbersVarArgs(1,2,3,4,5,6,7,8,9); //45
